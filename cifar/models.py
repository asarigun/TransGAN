...
class Attention(nn.Module):
    def __init__(self, dim, heads=8, attention_dropout=0., proj_dropout=0.5):
        super().__init__()
        self.heads = heads
...
class ImgPatches(nn.Module):
    def __init__(self, input_channel=3, dim=768, patch_size=16):
        super().__init__()
...
class Encoder_Block(nn.Module):
    def __init__(self, dim, heads=8, mlp_ratio=4, drop_rate=0.5):
        super().__init__()
...
class TransformerEncoder(nn.Module):
    def __init__(self, depth, dim, heads=8, mlp_ratio=4, drop_rate=0.5):
        super().__init__()
...
class Generator(nn.Module):
    ...
    def __init__(self, depth1=5, depth2=2, depth3=2, initial_size=8, dim=384, heads=8, mlp_ratio=4, drop_rate=0.5):#,device=device):
...
class Discriminator(nn.Module):
    def __init__(self, image_size=32, patch_size=16, input_channel=3, num_classes=1,
